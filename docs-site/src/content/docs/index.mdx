...
hero:
  title: KatanaKit
  tagline: HTTP client, logger, storage, DOM helpers, reactive signals, formatting, dates, geometry, and framework adapters — all with hexagonal architecture and zero side effects on import.
  actions:
    - text: Get Started
