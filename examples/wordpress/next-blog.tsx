					...
					return (
						<li key={post.id}>
							...
							<div>
								...
								{categoryNames.length > 0 && <span> in {categoryNames.join(", ")}</span>}
							</div>
							<div
								dangerouslySetInnerHTML={{
