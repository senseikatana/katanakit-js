...
const presets = [
  ...
  { api: "pokeapi", endpoint: "pokemonList", params: "{}", query: '{"limit": 5, "offset": 0}', label: "Pokemon List" },
  { api: "jsonplaceholder", endpoint: "postById", params: '{"id": 1}', query: "{}", label: "First Post" },
